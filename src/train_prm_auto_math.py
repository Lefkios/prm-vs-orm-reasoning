...
if "OPENAI_API_KEY" not in os.environ:
    raise EnvironmentError("OPENAI_API_KEY not set — add it to .env before running this script.")

CONFIG = {
    "model_path": "models/qwen2.5-7b-pytorch",
    "output_path": "models/prm-auto-math-trained",
    ...
    "wandb_run_name": "prm-auto-math-training",
    "lora_r": 16,
    "lora_alpha": 32,
    "lora_dropout": 0.05,
}
...
def prm_auto_reward_function(prompts, completions, answer, **kwargs):
    ...
    # batch every completion's step-judging into parallel API calls rather
    # than scoring one at a time — see reward_functions/auto_labels.py
...
def main():
    ...
    print("\nStarting PRM-auto-MATH training...")
    ...
    print("PRM-auto-MATH training complete.")
